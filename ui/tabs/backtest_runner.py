...
from backtesting.strategies import run_rl_trader, run_regime_trader, run_etf_benchmark, _ETF_OPTIONS  # noqa: F401

STRATEGY_EXPLAINER = """
| Strategy | Implementation |
|---|---|
| **RL Trader** | A2C framework. Observes 16 market features per symbol + portfolio state. Outputs softmax portfolio weights daily. |
...
def run_selected(
    ...
    *,
    ...
    steps = sum([run_rl, run_regime, bool(etf_benchmarks)])
    done = 0
    results = []
